...
const LPFooter: React.FC<FooterProps> = ({
  ...
  disclaimerText = "MUST BE 21+ TO PURCHASE. THE PRODUCTS DISPLAYED AND AVAILABLE FOR SALE ON THIS SITE (1) ARE HEMP-DERIVED CANNABINOID PRODUCTS THAT COMPLY WITH THE FEDERAL LEGAL LIMIT CONTAINING LESS THAN ZERO AND THREE-TENTHS (0.3%) DELTA-9 TETRAHYDROCANNABINOL, (2) DO NOT CLAIM TO DIAGNOSE, TREAT, MITIGATE, CURE, OR PREVENT ANY DISEASE, AND (3) HAVE NOT BEEN EVALUATED OR APPROVED BY THE UNITED STATES FOOD AND DRUG ADMINISTRATION (FDA) FOR SAFETY, EFFICACY, EFFECTIVENESS, OR QUALITY.",
  copyrightText = "© 2025, SunDay. All rights reserved. See our",
  termsLink = "https://drinkasunday.com/pages/terms-of-use",
  privacyLink = "https://drinkasunday.com/pages/privacy-policy",
  className = "",
}) => {
  // Sun/star logo icon
  const SunLogo = () => (
